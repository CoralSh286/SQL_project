...
שאילתה זו מציגה עבור כל חדר את מספר המיטות הפנויות בו ואת שמות המטופלים ששויכו אל אותן מיטות. 

הנתונים מוצגים בסדר יורד לפי כמות המיטות הפנויות, מה שמאפשר לזהות בקלות חדרים עם זמינות גבוהה.
