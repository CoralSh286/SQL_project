...
## שחזור DSD:
1. בשלב הראשון יצרנו את כל הישויות שאינן תלויות בשום ישות אחרת
   
2. בשלב השני זיהינו מה הן הטבלאות שיש לנו מפתח זר של טבלה אחרת, והקפדנו ליצור קודם את הטבלה בהן הן תלויות ואז אותן.
   
3. זיהינו תכונות מורכבות במידת הצורך.
...
1. יצרנו ישויות עבור הטבלאות שאינן טבלאות קשר.
  
2. יצרנו קשרים לפי התלויות שניתן לראות בטבלאות.
  
3. הוספנו מפתחות לפי המידע בטבלה.
