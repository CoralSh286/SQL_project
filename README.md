...
הפרוצדורה update_nurse_shift_new מקבלת מספר טלפון של אחות, מקבלת על פי מספר הטלפון שלה את המזהה שלה ומעדכנת את המשמרת של האחות בהתאם למשמרת הקודמת. אם המשמרת הקודמת היתה בוקר - כעת המשמרת תהיה צהרים וכו'. נעשה שימוש בבדיקות קיום, בטיפול בשגיאות (EXCEPTION) במקרה הצורך, ובהסתעפויות על מנת למצוא את המשמרת הרצויה.
